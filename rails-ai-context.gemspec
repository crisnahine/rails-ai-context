...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Stop AI from guessing your Rails app. 45 tools give coding agents ground truth - schema, models, routes, conventions - on demand. MCP or CLI."
  spec.description   = <<~DESC
    ...
    agents query 45 live tools (via MCP server or CLI) to get your actual schema,
