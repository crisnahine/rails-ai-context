...
module RailsAiContext
  module Tools
    class GetJobPattern < BaseTool
      ...
      # Distinguishes "the directory doesn't exist" from "the directory exists
      ...
      private_class_method def self.no_job_files_message(jobs_dir_exists)
        if jobs_dir_exists
          "app/jobs/ exists but has no job classes beyond ApplicationJob. This app may not use background jobs."
        else
          "No app/jobs/ directory found. This app may not use background jobs."
        end
      end
